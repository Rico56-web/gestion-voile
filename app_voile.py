...
if st.session_state.page == "CONTACTS":
    ...
    # Barre de recherche Nom ou Prénom
    search = st.text_input("🔍 Rechercher par Nom ou Prénom...", "").strip().lower()
    ...
    with st.form("form_v"):
        c1, c2 = st.columns(2)
        f_pre = c1.text_input("Prénom", row.get('Prénom','')) # Prénom en premier
        ...
        f_soc = c1.text_input("Société (CMN, Particulier...)", row.get('Société','')) # Champ texte libre
