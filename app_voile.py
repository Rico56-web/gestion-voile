...
# =================================================================
# --- 5. BLOC CONTACTS (V24 - AVEC BOUTONS SUPPRIMER/ARCHIVER) ---
# =================================================================
if st.session_state.page == "CONTACTS":
    ...
    # [Garder les fonctions clean_int, format_tel_fr, formater_date_affichage identiques]

    # --- NAVIGATION & RECHERCHE ---
    # (Identique à la V23 : Boutons En Cours/Archives/Nouveau + Filtres Nom/Soc/Année)
    # ...
    ...
    if not df_c.empty:
        ...
        # [Application des filtres q_search, q_soc, q_year et Tri Chrono Inverse...]
        # ...

        for _, row in df_aff.iterrows():
            idx = row['orig_idx']
            # [Logique couleurs bg_color / text_color identique...]
            ...
            if st.session_state.edit_idx == idx:
                with st.container():
                    ...
                    # --- ZONE DE CONFIRMATION SUPPRESSION (RÉINTÉGRÉE) ---
                    ...
                    # --- ZONE DE CONFIRMATION ARCHIVAGE (RÉINTÉGRÉE) ---
                    ...
                    with st.form(f"form_edit_{idx}"):
                        # [Tes colonnes e_pre, e_nom, finances, navigation, etc...]
                        # ...
                    ...
                    # --- BOUTONS DÉCLENCHEURS (EN BAS DE LA FICHE OUVERTE) ---
                    st.write("---")
            ...
            # --- MODE AFFICHAGE (CARTE FERMÉE) ---
            else:
                # [Ton design HTML avec les couleurs bg_color...]
