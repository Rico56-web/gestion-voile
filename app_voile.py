...
if st.session_state.page == "LISTE":
    ...
    # --- FIX STATUT AUTOMATIQUE ---
    # On définit l'index par rapport à ce qui est déjà enregistré
...
# [Pages FRAIS et NOTES conservées selon ta structure]
