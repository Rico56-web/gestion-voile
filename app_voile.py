        ...
        with st.form("form_v5"):
            ...
            if st.form_submit_button("💾 ENREGISTRER"):
                try:
                    ...
                    new = {"DateNav": f_date.strip(), "NbJours": str(f_nbj), "Nom": f_nom.upper(), "Prénom": f_pre.capitalize(), "Statut": f_stat, "PrixJour": f_prix, "Passagers": str(f_pass), "Téléphone": f_tel, "Email": init.get("Email",""), "Paye": "Oui", "Historique": f_his}
        ...
        for _, r in df.iterrows():
            try:
                ...
                for j in range(int(r.get('NbJours', 1))):
                    ...
                    if "🟢" in r['Statut']: greens.append(d_c)
                    elif "🟡" in r['Statut']: yellows.append(d_c)
            except: pass
        ...
        for week in cal:
            ...
            for i, day in enumerate(week):
                if day != 0:
                    ...
                    ico = "🟢" if d_s in greens else "🟡" if d_s in yellows else str(day)
