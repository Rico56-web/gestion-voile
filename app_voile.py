...
if st.session_state.page == "LISTE":
    ...
    if not df.empty:
        ...
        # Gestion du filtre FUTURES / ARCHIVES
...
# --- AUTRES PAGES (PLANNING, STATS, MAINTENANCE) ---
# [Le reste du code reste identique avec les corrections précédentes validées]
